let arr = [
    [16, '<b>55</b>', 88, 14, 27, 35, 87, 96, 23], [76, 70, 32, 89, 15, 95, 29, 59, 97], [49, 10, 93, 67, 80, 62, 54, 12, 73],
...
const clickedSquare = function (event) {
    ...
    if (idEvent.innerHTML != 'X') {
        ...
        for (let divK of divs) {
            document.getElementById(divK.id).innerText = arr[this.id][divK.id];
